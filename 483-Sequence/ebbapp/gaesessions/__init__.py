...
COOKIE_NAME_PREFIX = "EbbSess"  # identifies a cookie as being one used by gae-sessions (so you can set cookies too)
COOKIE_PATH = "/"
...
class SessionMiddleware(object):
    ...
    ``lifetime`` - ``datetime.timedelta`` that specifies how long a session may last.  Defaults to 7 days. TODO: Replaced DEFAULT_LIFETIME w/ None
